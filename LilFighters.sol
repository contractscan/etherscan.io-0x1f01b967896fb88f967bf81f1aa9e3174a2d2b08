// File: Lil Fighter.sol



// by @LilFightersNFT (Twitter)

// SPDX-License-Identifier: MIT
// File: contracts/Lil Fighter.sol
...
contract LilFighters is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeibgskx77fipxbwfdvq6v6g36ojcucpn6zkq2qkjszhnccc3pjrvha/";
    uint   public price             = 0.002 ether;
    uint   public maxPerTx          = 11;
    uint   public maxPerFree        = 1;
    uint   public maxPerWallet      = 42;
    uint   public totalFree         = 3232;
    uint   public maxSupply         = 3232;
    ...
    constructor() ERC721A("Lil Fighters", "FITR"){}
